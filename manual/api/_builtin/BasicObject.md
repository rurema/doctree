...
Object クラスは様々な便利なメソッドや [c:Kernel] から受け継いだ関数的メソッドを多数有しています。
...
このため、サブクラスで [m:BasicObject#==] を再定義しても != とは自動的に整合性がとれるようになっています。
...
そのためには、[m:Object#respond_to_missing?] も同様に override する必要があります。
