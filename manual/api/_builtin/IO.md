...
#@else
### def readlines(path, rs = $/, opts={})    -> [String]
### def readlines(path, limit, opts={})      -> [String]
### def readlines(path, rs, limit, opts={})  -> [String]
#@end
...
### def readlines(limit)      -> [String]
### def readlines(rs, limit)  -> [String]
#@end
...
#@else
### def write_nonblock(string)    -> Integer
#@end
