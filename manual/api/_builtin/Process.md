...
### module_function def euid        -> Integer
...
### module_function def gid        -> Integer
...
### module_function def uid        -> Integer
...
### const CLOCK_MONOTONIC -> Integer | Symbol
...
### const CLOCK_PROCESS_CPUTIME_ID -> Integer | Symbol
...
### const CLOCK_THREAD_CPUTIME_ID -> Integer

[m:Process?.clock_gettime] で使われます。

システムによっては定義されていません。

### const CLOCK_VIRTUAL -> Integer

[m:Process?.clock_gettime] で使われます。

システムによっては定義されていません。

### const CLOCK_PROF -> Integer
...
### const CLOCK_REALTIME_PRECISE -> Integer

[m:Process?.clock_gettime] で使われます。

システムによっては定義されていません。

### const CLOCK_REALTIME_COARSE -> Integer

[m:Process?.clock_gettime] で使われます。

システムによっては定義されていません。

### const CLOCK_REALTIME_ALARM -> Integer

[m:Process?.clock_gettime] で使われます。

システムによっては定義されていません。

### const CLOCK_MONOTONIC_FAST -> Integer

[m:Process?.clock_gettime] で使われます。

システムによっては定義されていません。

### const CLOCK_MONOTONIC_PRECISE -> Integer

[m:Process?.clock_gettime] で使われます。

システムによっては定義されていません。

### const CLOCK_MONOTONIC_COARSE -> Integer

[m:Process?.clock_gettime] で使われます。

システムによっては定義されていません。

### const CLOCK_MONOTONIC_RAW -> Integer

[m:Process?.clock_gettime] で使われます。

システムによっては定義されていません。

### const CLOCK_MONOTONIC_RAW_APPROX -> Integer

[m:Process?.clock_gettime] で使われます。

システムによっては定義されていません。

### const CLOCK_BOOTTIME -> Integer

[m:Process?.clock_gettime] で使われます。

システムによっては定義されていません。

### const CLOCK_BOOTTIME_ALARM -> Integer

[m:Process?.clock_gettime] で使われます。

システムによっては定義されていません。

### const CLOCK_UPTIME -> Integer

[m:Process?.clock_gettime] で使われます。

システムによっては定義されていません。

### const CLOCK_UPTIME_FAST -> Integer

[m:Process?.clock_gettime] で使われます。

システムによっては定義されていません。

### const CLOCK_UPTIME_RAW -> Integer

[m:Process?.clock_gettime] で使われます。

システムによっては定義されていません。

### const CLOCK_UPTIME_RAW_APPROX -> Integer

[m:Process?.clock_gettime] で使われます。

システムによっては定義されていません。

### const CLOCK_UPTIME_PRECISE -> Integer

[m:Process?.clock_gettime] で使われます。

システムによっては定義されていません。

### const CLOCK_SECOND -> Integer
...
### const RLIM_SAVED_MAX -> Integer

[m:Process?.getrlimit], [m:Process?.setrlimit] で使われます。詳しくは [man:setrlimit(2)] を参照して下さい。

### const WNOHANG -> Integer
