...
[c:Hash] など他の反復可能なクラスと異なり、ブロックを省略しても [c:Enumerator] は返しません。エントリが1つ以上ある状態でブロックを指定せずに呼び出すと
...
true・false・nil などの immediate な値はそれ自身を [m:Object#inspect] した結果が使われますが、それ以外のオブジェクトは to_s や inspect を呼び出さずに
