...
つまり、[m:IO#ioctl] などで C の構造体を渡すときのように、システム依存のサイズとエンディアンに合わせる必要があるときには
...
説明中、[m:Array#pack] と [m:String#unpack] で違いのあるものは `/` で区切って「Array#pack の説明 / String#unpack の説明」としています。
