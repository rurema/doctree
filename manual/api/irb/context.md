...
### def evaluate(line, line_no) -> object

ライブラリ内部で使用します。

### def exit(ret = 0) -> object
...
### def set_last_value(value) -> object
...
### const NOPRINTING_IVARS -> [String]

ライブラリ内部で使用します。

### const NO_INSPECTING_IVARS -> [String]

ライブラリ内部で使用します。

### const IDNAME_IVARS -> [String]
