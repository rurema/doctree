...
[m:Rinda::TupleSpace#take] や [m:Rinda::TupleSpaceProxy#take] などでは取り出したいタプルを指定するため、パターンをメソッドの引数に渡す必要があります。
...
[lib:rinda/rinda] および [lib:rinda/tuplespace] の名前空間を提供するモジュール。
