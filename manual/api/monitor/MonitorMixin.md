...
[m:Object#extend] したりすることでそのクラス/オブジェクトにモニタ機能を追加します。
...
上の例のように [m:Object#extend] を使って利用する場合は自動的に初期化されます。
...
しかし、MonitorMixin をクラス定義の際に [m:Module#include] を使って利用する場合は、initialize メソッドで super() か super を呼んで、初期化する必要があります。
