...
[`Fiddle::Handle.new(lib)`](m:Fiddle::Handle.new) と等価です。
...
### const ALIGN_DOUBLE -> Integer

C の構造体における double のアライメントの値。

### const ALIGN_FLOAT -> Integer

C の構造体における float のアライメントの値。

### const ALIGN_INT -> Integer

C の構造体における int のアライメントの値。

### const ALIGN_LONG -> Integer

C の構造体における long のアライメントの値。

### const ALIGN_LONG_LONG -> Integer

C の構造体における long long のアライメントの値。

### const ALIGN_SHORT -> Integer

C の構造体における short のアライメントの値。

### const ALIGN_VOIDP -> Integer

C の構造体における void* のアライメントの値。

### const ALIGN_INTPTR_T -> Integer

C の構造体における intptr_t のアライメントの値。

### const ALIGN_PTRDIFF_T -> Integer

C の構造体における ptrdiff_t のアライメントの値。

### const ALIGN_SIZE_T -> Integer

C の構造体における size_t のアライメントの値。

### const ALIGN_SSIZE_T -> Integer

C の構造体における ssize_t のアライメントの値。

### const ALIGN_UINTPTR_T -> Integer

C の構造体における uintptr_t のアライメントの値。

### const BUILD_RUBY_PLATFORM -> String
...
### const SIZEOF_SHORT -> Integer

Cでの sizeof(short) の値

### const SIZEOF_VOIDP -> Integer

Cでの sizeof(void*) の値

### const SIZEOF_INTPTR_T -> Integer

Cでの sizeof(intptr_t) の値

### const SIZEOF_UINTPTR_T -> Integer
...
### const TYPE_PTRDIFF_T -> Integer

C の ptrdiff_t 型を表す定数。

### const TYPE_SIZE_T -> Integer

C の size_t 型を表す定数。

### const TYPE_SSIZE_T -> Integer
