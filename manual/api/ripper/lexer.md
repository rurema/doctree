...
#@else
#@since 2.5.0
### def Ripper.lex(src, filename = '-', lineno = 1) -> [[Integer, Integer], Symbol, String, Ripper::Lexer::State]
#@else
### def Ripper.lex(src, filename = '-', lineno = 1) -> [[Integer, Integer], Symbol, String]
#@end
#@end
...
#@else
### def Ripper.tokenize(src, filename = '-', lineno = 1) -> [String]
#@end
...
#@since 2.5.0
### def lex -> [[Integer, Integer], Symbol, String, Ripper::Lexer::State]
#@else
### def lex -> [[Integer, Integer], Symbol, String]
#@end
...
#@else
### def parse -> [[Integer, Integer], Symbol, String]
#@end
