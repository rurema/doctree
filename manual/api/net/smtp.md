...
メールを送ったら [m:Net::SMTP#finish] を呼んでセッションを終了しなければいけません。
...
SMTP ではメールを送る側のホストの名前 (HELO ドメインと呼ぶ) を要求されます。HELO ドメインは [m:Net::SMTP.start], [m:Net::SMTP#start]
...
[c:Net::SMTP] は [RFC:3207] に基づいた STARTTLS を用いる方法、もしくは [RFC:8314] に基づいた方法
