...
このインターフェースからハードウェアアクセラレータなどを利用できます。
...
### def load_private_key(id=nil, data=nil) -> OpenSSL::PKey::PKey
