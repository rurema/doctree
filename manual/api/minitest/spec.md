...
### def infect_with_assertions(positive_prefix, negative_prefix, skip_regexp, map = {}) -> ()
...
### def must_be_within_delta(expected, delta = 0.001) -> true
### def must_be_close_to(expected, delta = 0.001) -> true
...
### def must_be_within_epsilon(actual, epsilon = 0.001) -> true
...
### def must_be_instance_of(klass) -> true
...
### def must_be_kind_of(klass) -> true
...
### def must_respond_to(method_name) -> true
...
### def must_be_same_as(actual) -> true
