...
### const VT_ARRAY -> Integer
配列（SafeArray）を示します（0x2000）。

### const VT_BOOL -> Integer
真偽値を示します（11）。

### const VT_BSTR -> Integer
文字列（BSTR）を示します（8）。
...
### const VT_UNKNOWN -> Integer
COMインターフェイスを示します（13）。

### const VT_USERDEFINED -> Integer
ユーザ定義型を示します（29）。
