...
### 組み込みクラスの更新
  ...
  - [c:ARGF.class]
    - 追加: `ARGF.class#codepoints`, [m:ARGF.class#each_codepoint]
...
### 標準添付ライブラリの更新 (優れたもののみ)
  ...
  - [lib:cgi]
    ...
    - [m:CGI#header] は `CGI#http_header` に名前を変更しました。[m:CGI#header] は別名として残っています。
  ...
  - [lib:syslog]
    ...
    - 追加: `Syslog::Priority`, [c:Syslog::Level], [c:Syslog::Option], [c:Syslog::Macros]
