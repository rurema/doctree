...
## 組み込みクラスの更新(注目すべきもののみ)
  ...
  - [c:Enumerable]
    - 新規メソッド
      ...
      - [m:Enumerable#each_cons]と[m:Enumerable#each_slice]がレシーバを返すようになりました。 <https://github.com/ruby/ruby/pull/1509>
...
## 実装の改善
  ...
  - [c:Struct]のアクセサが高速化されました。 <https://github.com/ruby/ruby/pull/5131>
