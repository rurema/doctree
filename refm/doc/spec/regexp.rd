...
正規表現に関しては[[unknown:リテラル/正規表現リテラル]]、[[unknown:組み込み変数 $&|組み込み変数/$&]]、[[c:Regexp]]そして[[c:MatchData]]なども参照して下さい。

 *このページのもくじ
   * [[unknown:正規表現/正規表現記号]]
   * [[unknown:正規表現/後方参照]]
   * [[unknown:正規表現/文字クラス]]
   * [[unknown:正規表現/バックトラック]]
   * [[unknown:正規表現/サンプル]]

== 正規表現記号

以下は、ruby がサポートする正規表現記号(メタ文字)の一覧です。
(正規表現のオプションについては[[unknown:リテラル/正規表現リテラル]]を参照してください)
...
ン([[unknown:リテラル/正規表現リテラル]]を参照)を指定するなどにより多バイト文字
にマッチし得る正規表現を指します。
...
: .
  ...
  モード。[[unknown:リテラル/正規表現リテラル]]を参照)では、改行を含む任意の
  1 文字にマッチします。
...
: [ ]
  ...
  文字クラス指定。[[unknown:正規表現/文字クラス]]を参照。
...
: \1, \2 ... \n
  ...
  後方参照(back reference)。[[unknown:正規表現/後方参照]]を参照。
...
: (?ixm-ixm)
  ...
  ンについては[[unknown:リテラル/正規表現リテラル]]を参照。
...
2 桁以上の後方参照も指定できますが、[[unknown:リテラル/バックスラッシュ記法]]
...
[] 内には文字列と同じ[[unknown:リテラル/バックスラッシュ記法]]と、
