...
#@end
  ...
  * [[c:Process]]
    * 新規メソッド
      * Process._forkが追加されました。これは [[man:fork(2)]] のコアメソッドです。このメソッドを直接呼び出さないでください。既存のforkメソッド([[m:Kernel.#fork]]、[[m:Process.fork]]、IO.popen("-"))によって呼び出されます。アプリケーションモニタリングライブラリは、このメソッドを上書きしてforkイベントをフックできます。 [[feature:17795]]
