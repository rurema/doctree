...
プログラムは[[unknown:プログラム/式]]を並べたものです。式と式の間はセミコロ
...
Ruby の式には、[[unknown:変数と定数]]、さまざまな[[unknown:リテラル]]、それらの
[[unknown:演算や代入|演算子式]]、if や while などの[[unknown:制御構造]]、
[[unknown:メソッド呼び出し]]、[[unknown:クラス／メソッドの定義]]があります。
