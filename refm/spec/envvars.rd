...
: RUBYPATH
  ...
  [[unknown:Rubyの起動/-S]] オプション指定時に、環境変数 PATH による
...
: RUBYLIB_PREFIX
  ...
  この環境変数は [[c:DJGPP]]版、[[c:Cygwin]]版、[[unknown:mswin32]]版、
  [[unknown:mingw32]]版のrubyでのみ有効です。
...
: RUBYSHELL
  ...
  この環境変数は [[c:OS2]]版、[[unknown:mswin32]]版、[[unknown:mingw32]]版のrubyで
  のみ有効です。
