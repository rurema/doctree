...
ただし、freeze された集合を dup および clone した場合、複製された集合の内部記憶
...
ただし、内部記憶の freeze 情報はコピーされません。
このため、freeze された集合を dup および clone した場合、生成された集合の要素は
変更可能である点に注意してください。
#@end
...
RBTree ライブラリ ([[url:https://rubygems.org/gems/rbtree]])
