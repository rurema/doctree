...
#@#tsort provides a module for topological sorting and
...
#@#* (('tsort')) is wrong name because this library uses
#@#  Tarjan's algorithm for strongly connected components.
#@#  Although (('strongly_connected_components')) is correct but too long,
