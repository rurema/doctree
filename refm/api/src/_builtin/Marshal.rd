...
[[m:Marshal#Marshal.dump]] が出力するデータフォーマットのバージョ
ン番号です。

[[m:Marshal#Marshal.load]] は、メジャーバージョンが異なるか、バー
ジョンの大きなマーシャルデータを読み込んだとき例外 [[c:TypeError]]
を発生させます。

マイナーバージョンが古いだけのフォーマットは読み込み可能ですが、
[[m:$VERBOSE]] = true のときには警告メッセージが
出力されます
