...
@raise MiniTest::Assertion 自身と実際の値が等しい場合に発生します。
...
--- wont_be_nil -> true
自身が nil でない場合、検査にパスしたことになります。

@raise MiniTest::Assertion 自身が nil である場合に発生します。

@see [[m:MiniTest::Assertions#refute_nil]]

--- wont_be -> true

自身の評価結果が偽である場合、検査にパスしたことになります。

@raise MiniTest::Assertion 自身が真である場合に発生します。
