...
オプションを解析し，`$OPT_xxx'に値を設定します．更に指定したオプシ
ョンが条件にあっていない場合，USAGE を表示します．
 ...
 * [[unknown:"ruby-src:sample/getopts.test"]]
 * [[unknown:"ruby-src:sample/biorhythm.rb"]]
...
: 第一引数:
`-'や`--'を伴って指定するオプション以外のオプションの最低必要数
を指定します．存在しない場合は0を指定します．
...
以下の例では，"-d" と最低でも "-x"，"-y"，"--geometry"のど
れか一つが実行時に必要なオプションとなります．
`parseArgs(0，"d&(x|y|geometry)"，"fd"，"x:"，"y:"，"geometry:"，"version")'

: 第三，第四引数:
[[lib:getopts]] の第一，第二引数と同じです．
