...
年の下2桁の表現であるとみなし上2桁を補います。69 以上なら 1900 年代とみなします。
...
日付解析し直ちに [[c:Date]]、あるいは [[c:DateTime]] オブジェクトを生成するには、
[[lib:date]] で提供される [[m:Date.parse]] や
DateTime.parse や [[m:Date.strptime]] や
DateTime.strptime などをつかうことができます。
