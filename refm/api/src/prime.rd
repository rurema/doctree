...
過去との互換性のために [[m:Prime.new]] も残っています。このメソッドはRuby 2.3から非推奨ですので、新しいプログラムでは利用しないでください。
...
#@until 2.3.0
--- new -> Prime
過去との互換性のためのメソッドです。2.3.0で削除されています。新しいプログラムでは [[m:Prime.instance]] やクラスメソッドを利用してください。
